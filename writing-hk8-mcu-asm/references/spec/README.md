...
> 版本：1.1.0
> 基线日期：2026-07-10
> 已实证芯片/板级基线：HK64S8101 及本项目所用 OLED、四位数码管开发板
> 来源项目：`D:\hk64s8x-cli`
...
4. **ORG、标签、MAP、PC、JMP、CALL 都是 word 地址。** HK64S8101 当前程序空间为 `0x0000..0x03FF`，即 1024 words / 2048 bytes。
...
2. [01-HK64S8x-ASM编码规范.md](01-HK64S8x-ASM编码规范.md)
3. 与任务相关的专题文档
...
- 每块新硬件建立独立 `board_profile`，不要把本项目 OLED/数码管接线升级为整个 HK64S8x 家族的默认值。
