...
| `rules/asm-rules.json` | 87 条机器可读规则；AI/CI 的主入口 |
...
- 实板明确标记的最终基线：
  ...
  - `HK64S825-SH1106-1P3-I2C-PB6-PB7-E1`：1.3 英寸 SH1106 128x64 板级 profile，方向探针与正式文字实板确认
...
- 当前 SH1106 正式文字程序在 page 1 查表全黑的具体根因；现阶段仅采用该应用的 page 0 保守布局。
